 ...
 */
final class Version20220815095431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD article_id INT DEFAULT NULL, DROP title');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD title VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP article_id, CHANGE comment comment VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
